...
class RodauthMain < Rodauth::Rails::Auth
  configure do
    ...
    # Note: create_account disabled for single-user setup (use CLI instead)
    # verify_account disabled - not needed for single-user initial setup
    enable :login, :logout, :jwt, :jwt_refresh, :json,
    ...
    # Dynamically detect database adapter from Active Record configuration
    db(
    ...
    # hmac_secret "bb10b638d5b376511a4056329a93a3ed6c1b5e503f2ad571ca2a473fd5cc9d55bd12453b42db3eebece08732528ecbf990df820eacda0ce6d00030cf80b78866"
    ...
    # verify_account_set_password? only works when verify_account feature is enabled
    # Since we disabled verify_account, we don't need this setting
    ...
    # ==> Remember Feature
    # Not needed for JWT - tokens handle session persistence
